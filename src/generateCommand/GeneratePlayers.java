...
public class GeneratePlayers implements GenerateCommand{
	...
	public GeneratePlayers(PlayersList playerList,ArrayList<String> playersNames){
		...
		System.out.print("Insira o total de fichas que cada jogador comecara(1000 to 10000): Caso seja double, sera arrendondado: " );
		while(true){
			...
			if(Poker.isNumeric(this.input) == true){
				...
				if(this.initChips < 1000 || this.initChips > 10000) System.out.println("Numero fora do valor limitado");
				else break;
			}
			else{
